# 深蓝之树 (Deep Blue Tree) - TurboWarp扩展文档

## 概述

深蓝之树是一个强大的Scratch/TurboWarp扩展，为用户提供大量高级数学运算和深度学习相关的积木块。从基础的向量矩阵运算到复杂的神经网络计算，这个扩展旨在让TurboWarp用户能够接触到更深层次的数学和AI概念，并填补TurboWarp没有人工智能扩展的空缺。

## 基本信息

- **扩展名称**: 深蓝之树 (深度学习)
- **扩展ID**: E_SLZS
- **描述**: 提供大量运算符积木块，从向量运算到张量
- **作者**: ELLRA-蓝电 | -LoveAuska-
- **许可证**: MIT
...
*深蓝之树 - 让深度学习和高级数学运算在Scratch中变得简单易用*
